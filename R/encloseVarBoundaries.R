...
#elementBoundaries takes fieldBookLLSPDF as input and through a series of functions generates blocks from a user-specific blocking input through a minimumb bounding geometry convex hull algorithm implemented in regeos. 
...
fieldBookLLSPDFChull <- lapply(fieldBookLLSPDFSplit, function(x){gConvexHull(x)}) 
